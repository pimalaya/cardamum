...
One report is produced per `(backend, provider)` pair, e.g. cairn/spec/testing/carddav-fastmail.md. Follow the steps below, record each variant, and fill in the report template at the end.
